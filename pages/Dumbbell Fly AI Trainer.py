...
from process_frame_flys import ProcessFrame
from threshold_fly import get_thresholds_beginner
...
if mode == "Upload video":
    ...
    if uploaded is None:
        ...
        output_path = os.path.join(tempfile.gettempdir(), "processed_flys.mp4")
    ...
    if os.path.exists(output_live):
        with open(output_live, "rb") as f:
            if st.download_button("📥 Download live recording", f, file_name="live_flys.flv"):
